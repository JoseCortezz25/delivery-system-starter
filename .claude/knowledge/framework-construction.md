...
Once `engine/` implements this framework (see `engine-principles.md`), the build may need to
diverge from what this document currently says — a value that looked right on paper doesn't
