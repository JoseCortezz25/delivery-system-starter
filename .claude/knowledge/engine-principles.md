...
`methodology.md` leaves the rendering engine outside the core method — it's technical
...
typography and scaling section (B5 of `tokenization.md`) explicitly defines otherwise.
